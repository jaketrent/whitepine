...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Supplier.website'
        db.add_column('supplier_supplier', 'website', self.gf('django.db.models.fields.CharField')(default='http://google.com', max_length=500), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Supplier.website'
        db.delete_column('supplier_supplier', 'website')
    ...
    models = {
        ...
        'supplier.supplier': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'title_slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'website': ('django.db.models.fields.CharField', [], {'default': "'http://google.com'", 'max_length': '500'})
        }
    }
